...
from .views import beautifulBalanceView, homePageView, passwordUpdateSuccessView, transferView, createAccountView, accountCreateSuccessView, updatePasswordView
...
urlpatterns = [
    ...
    path('beautifulbalance/<int:uid>/', beautifulBalanceView, name='beautifulbalance')
]
